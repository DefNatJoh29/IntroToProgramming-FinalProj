...
//         let imageUrl = player.image || "https://placehold.co/300x200?text=No+Image"

//         const card = document.createElement("div")

//         card.className = "favlist-card"
...
//     for(let i=0; i<favList.length; i++){
//         if(favList[i].id === player.idPlayer || favList[i].id === player.id){
//             found = true
//             break
//         }
//     }
...
//         favList.push({id: player.idPlayer, name: player.strPlayer, image:imageUrl})
//     }
//     savefavlist()
//     renderFavs()
...
//     let word = (count === 1)? "player": "players"

//     favListCount.textContent = `You have ${count} saved ${word}`
// }
...
//     const confirmed = confirm(`Remove all ${favList.length} saved players?`)
